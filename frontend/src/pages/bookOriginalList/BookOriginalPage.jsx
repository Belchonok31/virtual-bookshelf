...
import {getBookOriginalsAll,
        createBookOriginal,
        updateBookOriginal,
        removeBookOriginal} from '../../redux/features/bookOriginals/bookOriginalActions'
...
const BookOriginalPage = () => {
    ...
    const handleShow = (BookOriginal = null) => {
        if (BookOriginal) {
            ...
            setBookOriginalForm({ name: BookOriginal.name, authors: BookOriginal.authors,
